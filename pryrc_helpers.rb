module PryrcHelpers
  ...
  def welcome_messages
    [
      "Let this be your day Svajone!",
      "Kareem you are awesome!",
      "Svajone is amazing!",
      "Let us dance you and I, Kareem!",
      "Mano Svajone!",
      "Take this well Kareem for you are Svajone.",
      "Kareem is cool!"
    ].sample
  end
  ...
  def farewell_messages
    [
     "Nice to see you Svajone!",
     "We'll dream again soon Svajone!",
     "See you nex time Kareem!",
     "Glad you came by Kareem!"
    ].sample
  end
